...
with col1:
    st.title('DisfrutaMadrid')
    st.header('¿Conoces Madrid?')
    st.subheader('El reloj de la Puerta del Sol es un regalo')
    ...
    st.subheader('Madrid también tiene una estatua de la Libertad')
    ...
    st.image(Image.open('../proyecto/imagenes/madrid2.jpg'))
    
with col2:
    st.image(Image.open('../proyecto/imagenes/mapa_madrid.jpg'))
    st.subheader('Muchas casas tienen un cartel de Asegurada de Incendios')
    ...
    st.subheader('A los madrileños nos llaman Gatos')
